...
export class ProductForm extends Component {
    ...
    render(){
        return <div>
            <br/>
            Id:<input type="number" name="id" className="form-control" onChange={(e)=>this.setState({[e.target.name]:e.target.value})} />
            Name:<input type="text" name="name" className="form-control" onChange={(e)=>this.setState({[e.target.name]:e.target.value})} />
            Price:<input type="number" name="price" className="form-control" onChange={(e)=>this.setState({[e.target.name]:e.target.value})} />
            <br/>
